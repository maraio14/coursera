...
public:
   ...
   virtual void SetTypes(ClassTable* classTable) = 0;
...
public:
   ...
   virtual void RegisterClass(ClassTable* classTable) = 0;
   virtual void SetTypes(ClassTable* classTable) = 0;
   virtual Symbol GetSymbol() = 0;
   virtual Symbol GetParentSymbol() = 0;
   virtual SymbolTable<Symbol, Feature_class>& GetMemberFunctions() = 0;
   virtual SymbolTable<Symbol, Entry>& GetObjects() = 0;
...
public:
   ...
   virtual void RegisterMember(ClassTable* classTable, Class_ cls) = 0;
   virtual void SetType(ClassTable* classTable, Class_ cls) = 0;
   virtual bool IsAttribute() = 0;
   virtual Symbol GetFeatureName() = 0;
...
public:
   ...
   virtual void RegisterFormal(ClassTable* classTable, Class_ cls) = 0;
   virtual Symbol GetFormalType() = 0;
...
public:
   ...
   virtual void SetExpressionType(ClassTable* classTable, Class_ cls) = 0;
...
public:
   ...
   virtual void SetTypes(ClassTable* classTable, Class_ cls) = 0;
   virtual Symbol GetExprType() = 0;
...
public:
  ...
  virtual void SetTypes(ClassTable* classTable) override;
...
protected:
   ...
   Features features;
   Symbol filename;
   SymbolTable<Symbol, Feature_class> memberFunctions;
   SymbolTable<Symbol, Entry> objectsType;
public:
   class__class(Symbol a1, Symbol a2, Features a3, Symbol a4);
   virtual ~class__class();
   virtual Symbol GetSymbol() override {return name;}
   virtual Symbol GetParentSymbol() override {return parent;} 
   virtual Features GetFeatures() override {return features;}
   virtual void RegisterClass(ClassTable* classTable) override;
   virtual void SetTypes(ClassTable* classTable) override;
   SymbolTable<Symbol, Feature_class>& GetMemberFunctions() override {return memberFunctions;}
   SymbolTable<Symbol, Entry>& GetObjects() override {return objectsType;}
   Class_ copy_Class_();
   void dump(ostream& stream, int n);
...
public:
   ...
   virtual void SetType(ClassTable* classTable, Class_ cls) override;
   virtual void RegisterMember(ClassTable* classTable, Class_ cls) override;
   virtual bool IsAttribute() override {return false;};
   virtual Symbol GetFeatureName() override {return name;}
...
public:
   ...
   virtual void RegisterFormal(ClassTable* classTable, Class_ cls) override;
   virtual Symbol GetFormalType() override {return type_decl;}
   Formal copy_Formal();
   void dump(ostream& stream, int n);
...
public:
   ...
   void SetTypes(ClassTable* classTable, Class_ cls);
   virtual Symbol GetExprType() {return expr->get_type();}
...
public:
   ...
   virtual void SetExpressionType(ClassTable* classTable, Class_ cls) override;
