...
def find_events(ls_symbols, d_data, column_event):
...
def EventProfile(dt_start, dt_end, spProfile):
    ...
    ep.eventprofiler(df_events, d_data, i_lookback=20, i_lookforward=20,
                s_filename=spProfile+'.pdf', b_market_neutral=True, b_errorbars=True,
                s_market_sym='SPY')
...
if __name__ == '__main__':
    ...
    EventProfile(dt_start, dt_end, 'sp5002012')