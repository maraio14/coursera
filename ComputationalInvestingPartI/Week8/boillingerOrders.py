...
def generate_orders(d_data):
	...
	writer = csv.writer(open('boillinger_orders.csv', 'w'), delimiter=',')
	...
	for s_sym in ls_symbols:
		for i in range(1, len(ldt_timestamps) - 1):
			...
			if f_boillinger_yest >= -2. and f_boillinger_today < -2. and f_boillinger_spy >= 1.1:
...
if __name__ == '__main__':
	...
	df_events = generate_orders(d_data)
